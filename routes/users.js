...
router.get('/user-login',nocache(),userget.userGetLogin) 
...
router.get('/check-out',nocache(),userget.UserGetCheckOut)
...
router.get('/user-orderstatus',userget.userGetOrderStatus)
router.get('/editaddress',userget.userGetEditAddress)
...
router.get('/ordered-productdata/:id',userget.userOrderedProductData)
router.get('/ordered-productdata',userget.UserOrderProductwithoutId)
...
router.get('/addtowallet/:id/:grandtotal',userget.userAddToWallet)
...
router.post('/user-shopcart/:id',userpost.UserPostShopCart)
router.post('/update-quantity',userpost.userPostUpdateQuantity)
router.post('/usersaddress',userpost.UserPostAddress)
router.post('/passwordchange',userpost.UserProfilePassChange)
router.post('/orderlistpass',userget.userPostOrderListPass)
router.post('/verify-payment',userpost.userGetverifypayment)
router.post('/coupentry',userpost.UserTryCoupen) 
